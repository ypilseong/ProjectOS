...
Available tools include project creation/listing, file upload, task status
checks, ontology/graph builds, graph health checks, career graph queries, digest
generation/reading, vault note reading, and trace reading. See
`docs/claude-desktop-mcp.md` for the full setup.
