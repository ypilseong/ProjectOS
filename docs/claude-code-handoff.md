...
- Tool adapter: `projectos_create_project`, `projectos_list_projects`, `projectos_get_graph_health`, `projectos_query_career_graph`, `projectos_generate_digest`, `projectos_list_digests`, `projectos_get_digest`, `projectos_get_vault_note`, `projectos_read_traces`.
